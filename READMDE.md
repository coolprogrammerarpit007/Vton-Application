...
Ngrok installed for exposing local static files to the FASHN API.
...
DATABASE_URL=mysql+pymysql://root:yourpassword@localhost:3306/vton_app
...
Copy the forwarding URL (e.g., https://a1b2-34-56-78.ngrok-free.app).

Open backend/app/main.py and update the base_url variable in the create_tryon_job function:

base_url = "https://your-ngrok-subdomain.ngrok-free.app/static_uploads"
